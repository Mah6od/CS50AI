...
def shortest_path(source, target):
    ...
    # Initialize frontier using QueueFrontier
    ...
    while not frontier.empty():
        ...
        # Explore neighbors
        for action, neighbor in neighbors_for_person(current_node.state):
            if neighbor not in explored and not frontier.contains_state(neighbor):
                ...
                new_node = Node(state=neighbor, parent=current_node, action=action)
